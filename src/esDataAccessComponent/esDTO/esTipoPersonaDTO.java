package esDataAccessComponent.esDTO;

public class esTipoPersonaDTO {
    ...
    public esTipoPersonaDTO() {}
    public esTipoPersonaDTO(Integer esIdCatalogo, Integer esIdCatalogoTipo, String esNombre, String esDescripcion,
